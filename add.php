...
<form method="post" action="add.php" enctype="multipart/form-data">
  ...
  <input type="text" class="form-control" onkeypress='return charCode != 46 && charCode > 31 && (charCode < 48 || charCode > 57' id="prix" placeholder="Enter prix" aria-describedby="prixHelp" placeholder="Enter prix" name="prix" required>
  </div>
  <div class="form-group">
